...
describe ConferencesController do
  ...
  context "creating a new conference" do
    ...
    context "with broken json" do
      before do
        post "/ws/conferences", "this,is,no,js\"//\"on", "CONTENT_TYPE" => "application/json"
      end
  ...
  context "changing" do
    context "existing conferences" do
      context "with valid data" do
        before do
          ...
          put "ws/conferences/#{@c.id}", @c2.to_json, "CONTENT_TYPE" => "application/json"
        end
    ...
    context "non-existing conferences" do
      before do
        put "ws/conferences/10000000", @c2.to_json, "CONTENT_TYPE" => "application/json"
      end
