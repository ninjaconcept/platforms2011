Feature: Signup
  ...
  Scenario Outline: Signup with invalid data
    ...
    Examples:
      ...
      | oli@plat-forms.org |            |                       | 1 error prohibited this user from being saved |
      | oli@plat-forms.org | superpass  |                       | 1 error prohibited this user from being saved |
      | oli@plat-forms.org | superpass  | superpass1            | 1 error prohibited this user from being saved |
      | oli@plat-forms.org | superpass1 | superpass             | 1 error prohibited this user from being saved |
